...
def plexus_logic():
    ...
    instructions = ("Instructions:\n"
                    "1. Select the Award File for Plexus.\n"
                    "2. Select the BOM file for Plexus.\n"
...
def process_and_merge_files(parent_window):
    ...
    try:
        ...
        column_formats = {
            'AK': '"$"#,##0.0000',  # Currency values with two decimal places
            'AN': '"$"#,##0.0000',  # Currency values with two decimal places
...
def process_first_file(sheet):
    ...
    required_headers = ['EAU Qty', 'Unit Price', 'Min Order Qty']
    ...
    new_headers_formulas = {
        ...
        'Ext Award Value': f"={get_column_letter(header_column_map['EAU Qty'])}{{row}}*{get_column_letter(header_column_map['Unit Price'])}{{row}}",
        'Award Conf': None,
        'EAU': f"={get_column_letter(header_column_map['EAU Qty'])}{{row}}",
        ...
        'Award MOQ': f"={get_column_letter(header_column_map['Min Order Qty'])}{{row}}",
